...
public class MealsUtil {
    public static final List<Meal> MEALS_USER_ID1 = Arrays.asList(
            new Meal(LocalDateTime.of(2015, Month.MAY, 28, 10, 0), "Завтрак", 501),
    ...
    public static final List<Meal> MEALS_USER_ID2 = Arrays.asList(
