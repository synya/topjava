...
public class MealsUtil {
    public static void main(String[] args) {
        List<MealTo> mealsWithExcess = getFilteredWithExcess(MealTestData.LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000);
        mealsWithExcess.forEach(System.out::println);

        System.out.println(getFilteredWithExcessByCycle(MealTestData.LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExcessInOnePass(MealTestData.LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
        System.out.println(getFilteredWithExcessInOnePass2(MealTestData.LIST, LocalTime.of(7, 0), LocalTime.of(12, 0), 2000));
    }
